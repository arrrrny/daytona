...
class ProcessApi:
    ...
    @validate_call
    async def exec_connect(
        self,
        token: Annotated[Optional[StrictStr], Field(description="SSH access token (alternative to the Authorization header for WS clients that cannot set headers)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param token: SSH access token (alternative to the Authorization header for WS clients that cannot set headers)
        :type token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._exec_connect_serialize(
            token=token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def exec_connect_with_http_info(
        self,
        token: Annotated[Optional[StrictStr], Field(description="SSH access token (alternative to the Authorization header for WS clients that cannot set headers)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def exec_connect_without_preload_content(
        self,
        token: Annotated[Optional[StrictStr], Field(description="SSH access token (alternative to the Authorization header for WS clients that cannot set headers)")] = None,
        _request_timeout: Union[
            None,
    ...
    def _exec_connect_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/process/exec/connect',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
